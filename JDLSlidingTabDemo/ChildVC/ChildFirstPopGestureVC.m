...
//  JDLSlidingTabDemo
//
//  Created by https://github.com/BlueSkyer-26 on 2017/12/7.
...
- (void)viewDidLayoutSubviews {
    ...
    // 切记：纯代码在 viewDidLoad 方法中创建 tableView 时，高度一定要等于 JDLSlidingTabContent 的高度 self.view.frame.size.height - 108 或 使用 Masonry 进行 下面一句代码的约束；
